        ...
        <div class="footer__wrapper">
            <ul class="socials">
                <li><a target="_blank" rel="nofollow noopener" href="https://vk.com/popovalex">
                        <svg class="icon vk" viewBox="0 0 192 192">
                ...
                <li><a target="_blank" rel="nofollow noopener" href="https://t.me/shurikation">
                        <svg class="icon tg" viewBox="0 0 240 240">
                            <linearGradient id="tg-footer" x1="46.1" x2="28.8" y1="11.5" y2="51.9"
                            ...
                            <g transform="scale(3.47)">
                                <circle cy="34.6" cx="34.6" r="34.6" fill="url(#tg-footer)"/>
                ...
                <li><a target="_blank" rel="nofollow noopener" href="https://github.com/shurikation">
                        <svg class="icon git" viewBox="0 0 24 24">
            ...
            <p class="footer__copyright">&copy;Alexander Popov, 2020</p></div>
    </div>
</footer>
<?php
    wp_footer();
